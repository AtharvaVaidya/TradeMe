...
public class Request: RequestProtocol
{
    ...
    public var authenticationToken: AuthenticationToken = AuthenticationToken()
    ...
    ///   - body: body to set
    public init(method: HTTPMethod = .get, endpoint: String = "", params: ParamsDict? = nil, headers: HeadersDict? = nil, fields: ParamsDict? = nil, body: RequestBody? = nil, page: Int? = nil, authenticationRequired: Bool = true)
    {
        self.method = method
